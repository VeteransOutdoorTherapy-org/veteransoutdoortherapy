...
export const events: Event[] = [
	...
	},
	{
		...
		overview: participantDetails,
		detailsTitle: "What participants can expect",
		details: "Veterans from Texas and Kansas gathered in the Flint Hills for four days of chasing birds together.",
		ctaLabel: "Apply for support",
		ctaHref: "/apply",
		template: "adventure",
		published: true,
	...
	},
	{
		...
		overview: participantDetails,
		detailsTitle: "What participants can expect",
		details: "The group was hosted at the ranch, with first-year funding support from the Military Order of the Purple Heart.",
		ctaLabel: "Apply for support",
		ctaHref: "/apply",
		template: "adventure",
		published: true,
