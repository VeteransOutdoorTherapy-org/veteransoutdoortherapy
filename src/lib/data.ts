...
export const events: Event[] = [
	...
	},
	{
		...
		endDate: "2026-05-17",
		image: `${uploads}/2026/09/flint-hills/recap-04.jpg`,
		type: "Hunt",
		location: "Flint Hills, Kansas",
		summary: "A turkey hunt in the Flint Hills centered on challenge, recovery, and community.",
	...
	},
	{
		...
		title: "South Dakota Archery Antelope Hunt",
		date: "September 16 - September 20, 2026",
		startDate: "2026-09-16",
		endDate: "2026-09-20",
		image: `${uploads}/2026/09/antelope-sd/hero.jpg`,
		type: "Archery antelope hunt",
		location: "Belle Fourche, South Dakota",
		summary:
			"Five Soldiers from Nebraska, Missouri, South Dakota, and Oklahoma spent the weekend chasing antelope with a bow on the prairie outside Belle Fourche.",
	...
	},
	{
		...
		summary: "The first annual horseback riding adventure brought female Veterans from Alabama, Wisconsin, South Dakota, and Missouri together for a week in the saddle.",
	...
	{
		slug: "missouri-turkey-hunt-2027",
		title: "Missouri Turkey Hunt",
		...
		type: "Hunt",
		location: "Missouri",
		summary: "The Missouri Turkey Hunt returns for 2027 with the same sponsored land and guide support that made the inaugural hunt possible. Exact dates will be announced soon.",
		heroTitle: "Find connection in the spring woods.",
		overviewTitle: "A shared hunt with a larger purpose.",
		overview: participantDetails,
		detailsTitle: "What participants can expect",
		details: "Veterans from across the country join local landowners, guides, volunteers, and community supporters for the hunt each spring. Apply now to be considered once dates are confirmed.",
		ctaLabel: "Apply for support",
		ctaHref: "/apply",
		template: "adventure",
		published: true,
	...
	{
		slug: "flint-hills-kansas-turkey-hunt-2027",
		title: "Flint Hills, KS Turkey Hunt",
		date: "Spring 2027 (dates TBA)",
		...
		type: "Hunt",
		location: "Flint Hills, Kansas",
		summary: "The Flint Hills turkey hunt returns for 2027. Exact dates will be announced soon.",
		heroTitle: "Head into the Flint Hills together.",
		overviewTitle: "Open country. Shared purpose.",
		overview: participantDetails,
		detailsTitle: "What participants can expect",
		details: "Veterans gather in the Flint Hills each spring for this sponsored hunt. Apply now to be considered once dates are confirmed.",
		ctaLabel: "Apply for support",
		ctaHref: "/apply",
		template: "adventure",
		published: true,
	...
	{
		slug: "coulter-lake-guest-ranch-2027",
		title: "Coulter Lake Guest Ranch",
		date: "Summer 2027 (dates TBA)",
		startDate: "2027-07-01",
		endDate: "2027-07-31",
		image: `${uploads}/2026/09/horseback/horseback-01.jpg`,
		type: "Female horseback camp",
		location: "Coulter Lake Guest Ranch, Rifle, Colorado",
		summary: "The horseback riding adventure returns for female Veterans in 2027. Exact dates will be announced soon.",
		heroTitle: "Ride into room to reconnect.",
		overviewTitle: "A supported ranch experience.",
		overview: participantDetails,
		detailsTitle: "What participants can expect",
		details: "The ranch welcomes the group back in 2027. Apply now to be considered once dates are confirmed.",
		ctaLabel: "Apply for support",
		ctaHref: "/apply",
		template: "adventure",
		published: true,
	...
	},
	{
		...
		type: "Fundraiser",
		location: "Columbia, Missouri",
		summary: "The Poker Run returns to Head's Blacktop Harley-Davidson in 2027 to raise money for Veterans and Gold Star families. Exact date will be announced soon.",
		heroTitle: "Ride with purpose.",
		overviewTitle: "Start and finish together.",
		overview: "The Veteran's Outdoor Therapy Poker Run returns to Head's Blacktop Harley-Davidson in 2027, with an exact date to be announced.",
		detailsTitle: "Every mile funds recovery.",
		details: "Proceeds support fishing, hiking, camping, and hunting experiences that promote healing, camaraderie, and recovery.",
		ctaLabel: "Support the mission",
		ctaHref: "/donate",
		template: "fundraiser",
	...
	{
		slug: "white-river-fly-fishing-2027",
		title: "White River Fly Fishing",
		date: "Late Summer 2027 (dates TBA)",
		startDate: "2027-08-01",
		endDate: "2027-09-30",
		image: `${uploads}/2026/09/fishing/fishing-02.jpg`,
		type: "Fishing trip",
		location: "Rainbow Drive Resort, White River, Arkansas",
		summary: "The fly-fishing trip on Arkansas's White River returns for 2027, guided by an Army Veteran instructor. Exact dates will be announced soon.",
		heroTitle: "Cast into calmer water.",
		overviewTitle: "Days on the water.",
		overview: participantDetails,
		detailsTitle: "What participants can expect",
		details: "Veterans spend several days learning to fly fish on the White River with an Army Veteran instructor. Apply now to be considered once dates are confirmed.",
		ctaLabel: "Apply for support",
		ctaHref: "/apply",
		template: "adventure",
		published: true,
	...
	{
		slug: "missouri-snagging-trip-2027",
		title: "Missouri Paddlefish Snagging Trip",
		date: "Spring 2027 (dates TBA)",
		...
		heroTitle: "Get back on the river.",
		overviewTitle: "A season built on volunteers.",
		overview: participantDetails,
		detailsTitle: "What participants can expect",
		details: "Veterans spend days snagging paddlefish and evenings around the campfire. Apply now to be considered once dates are confirmed.",
		ctaLabel: "Apply for support",
		ctaHref: "/apply",
		template: "adventure",
		published: true,
	...
	// Trips that already had a field note but no event record, built from those
	// notes. Each takes the title of the same trip's 2027 record, so the two years
	// find each other.
	{
		...
		type: "Snagging trip",
		location: "Missouri River, Missouri",
		summary: "Veterans spent the weekend snagging paddlefish on the Missouri River and the evenings around the fire at camp.",
		heroTitle: "Days on the river, nights by the fire.",
		overviewTitle: "How the weekend went.",
		overview:
			"The 2026 Missouri snagging season went into the books with Veterans out on the river by day, pulling in paddlefish, and back at camp around the fire each night.",
		detailsTitle: "Who made it possible",
		details: "VFW Post 2657 and their Riders Group helped fund the trip, along with the volunteers who made it happen.",
		ctaLabel: "Read the field note",
		ctaHref: "/field-stories",
	...
	},
	{
		...
		endDate: "2026-03-13",
		image: `${uploads}/2026/09/wilderness-to-wellness/official-02.jpg`,
		type: "Benefit dinner",
		location: "54 Country, Missouri",
		summary: "A full house of Veterans, volunteers, sponsors, and supporting organizations at 54 Country for the first Wilderness to Wellness benefit dinner.",
		heroTitle: "The first Wilderness to Wellness dinner.",
		overviewTitle: "How the night went.",
		overview:
			"Veterans, volunteers, table sponsors, and supporting organizations filled 54 Country for an evening of food, fellowship, and fundraising, and Combat Veterans Motorcycle Association Chapter 4-7 joined the celebration.",
		detailsTitle: "Who made it possible",
		details: "The volunteers, the table sponsors, and every guest who placed a bid, donated, and shared in the evening.",
		ctaLabel: "Read the field note",
		ctaHref: "/field-stories",
	...
	},
	{
		...
		endDate: "2026-08-31",
		image: `${uploads}/2026/09/fishing/fishing-04.jpg`,
		type: "Fishing trip",
		location: "Rainbow Drive Resort, White River, Arkansas",
		summary: "Veterans from Georgia and Missouri spent four days on Arkansas's White River learning to fly fish.",
		heroTitle: "Four days on the water.",
		overviewTitle: "How the trip went.",
		overview:
			"The group started with an afternoon of fly-casting basics, then waded in and spent the days finding fish, telling stories, and maybe picking up a new hobby.",
		detailsTitle: "Who made it possible",
		details:
			"Army Veteran Stan of Tat2flyfisher Guide Services taught the group to cast. Rainbow Drive Resort arranged an experienced guide for the trip, and Natural State Fly Shop supplied wader rentals.",
		ctaLabel: "Read the field note",
		ctaHref: "/field-stories",
		recapUrl:
			"https://www.facebook.com/permalink.php?story_fbid=pfbid02kwhiWbA6Ky1ZCPywcFXsdFybkEc6LpaA1iQMCyipNsCFxny57JRgJwja9qnibMh4l&id=61573994307519",
		template: "adventure",
		published: true,
		featured: false,
		over: true,
...
export const fieldStories: FieldStory[] = [
	...
	},
	{
		...
		image: `${uploads}/2026/09/wilderness-to-wellness/official-02.jpg`,
		imageAlt: "Guests at the buffet line at the Wilderness to Wellness benefit dinner at 54 Country",
		body: [
			...
			"\"What an incredible night at the Veteran's Outdoor Therapy Inaugural Benefit Dinner,\" the organization shared afterward. \"We want to say THANK YOU to everyone who made our first banquet a success. To our volunteers, your time, energy, and passion are the backbone of this organization. To our table sponsors, your support helps us continue providing life-changing experiences for our Veterans and Gold Star Families. And to every guest who showed up, placed bids, donated, and shared in the evening, you are the reason this mission continues.\"",
			"Combat Veterans Motorcycle Association Chapter 4-7 joined the celebration as well, and shared afterward: \"Great evening at Veteran's Outdoor Therapy Inaugural Benefit Dinner, with a full house of veterans and other supporting organizations. Already looking forward to next year's event!\"",
			"The dinner raised support for the hunts, fishing trips, horseback rides, and other outdoor experiences that make up the Wilderness to Wellness mission, and set the stage for it to become an annual tradition.",
		],
		facebookLinks: [
			{ href: "https://www.facebook.com/share/p/18jSBLgpCR/", label: "Read the recap on Facebook" },
			{ href: "https://www.facebook.com/share/p/1ED884Mj3j/", label: "See Combat Veterans MC Chapter 4-7's post" },
		],
		...
		photoGalleries: [
			{
				...
				photos: [
					{ src: `${uploads}/2026/09/wilderness-to-wellness/official-01.jpg`, alt: "Silent auction floor at the Wilderness to Wellness benefit dinner" },
					{ src: `${uploads}/2026/09/wilderness-to-wellness/official-02.jpg`, alt: "Guests at the buffet line at the Wilderness to Wellness benefit dinner" },
					{ src: `${uploads}/2026/09/wilderness-to-wellness/official-03.jpg`, alt: "Guests posing together at the Wilderness to Wellness benefit dinner" },
					{ src: `${uploads}/2026/09/wilderness-to-wellness/official-04.jpg`, alt: "A guest holding up a winning auction bid card" },
					{ src: `${uploads}/2026/09/wilderness-to-wellness/official-05.jpg`, alt: "Guests posing together at the Wilderness to Wellness benefit dinner" },
