...
export const events: Event[] = [
	...
	},
	{
		...
		type: "Hunt",
		location: "Flint Hills, Kansas",
		summary: "A turkey hunt in the Flint Hills returns for 2027, hosted again by Forest, Jardine, and Dru. Exact dates will be announced soon.",
		heroTitle: "Head into the Flint Hills together.",
		overviewTitle: "Open country. Shared purpose.",
		overview: participantDetails,
		detailsTitle: "What participants can expect",
	...
	},
	{
		...
		overview: participantDetails,
		detailsTitle: "What participants can expect",
		details: "Kelly and Forest Keith, Dina, and Maru return to host the group again in 2027. Apply now to be considered once dates are confirmed.",
		ctaLabel: "Apply for support",
		ctaHref: "/apply",
		template: "adventure",
		published: true,
